...
export const places: IPlace[] = [
  ...
  },
  {
    name: "Bucke Cafe",
    id: "8",
    shortDesc: "A trendy spot with a warm atmosphere, offering artisan coffee and gourmet pastries.",
    description: "Bucke Cafe is a popular establishment known for its inviting vibe, delicious coffee, and a variety of pastries and brunch options. Frequented by locals and tourists alike, it's a lovely spot to unwind or catch up with friends.",
    image: "https://lh3.googleusercontent.com/p/AF1QipP-tNzdaiLmGH_U3aump2ik64neQwbhM9Kx-OWG=s680-w680-h510",
    starred: false,
    category: "food",
    reviews: [],
    link: "https://www.bucke-cafe.com/",
    address: "Ahad Ha'Am St 91, Tel Aviv-Yafo"
  },
  {
    name: "Lehamim Bakery",
    id: "9",
    shortDesc: "A renowned bakery that provides a plethora of freshly baked goods and pastries.",
    description: "Lehamim Bakery, widely recognized for its quality and variety, offers freshly baked bread, pastries, and delightful treats. It is an ideal place to enjoy the exquisite aromas of fresh baking while relishing a tasty snack.",
    image: "https://lh3.googleusercontent.com/p/AF1QipPssWIlSo_2Fw2bHydGVQeuDllb6x1vu2Ay7Z-i=s680-w680-h510",
    starred: true,
    category: "food",
    reviews: [],
    link: "https://www.lehamim.co.il/",
    address: "Hashmona'im St 103, Tel Aviv-Yafo"
  },
  {
    name: "Cafe Xoho",
    id: "10",
    shortDesc: "A vibrant cafe with a bohemian flair, known for its vegan and vegetarian dishes.",
    description: "Cafe Xoho is cherished for its lively and bohemian atmosphere, welcoming guests to try a range of vegan and vegetarian meals. With a creative menu and a friendly setting, it’s a superb place for casual meets and hearty meals.",
    image: "https://lh3.googleusercontent.com/p/AF1QipNiLMzTvqddx-UuZOBcvvVlgUM3Gdzpq1RmCN7u=s680-w680-h510",
    starred: false,
    category: "food",
    reviews: [],
    link: "https://www.cafexoho.com/",
